...
- **Редактор.** Таймлайн с плёнкой кадров и полосой движения, перетаскивание границ с
  магнитом к найденным событиям, разделение и слияние шагов, словарные списки, подсветка
  неуверенных шагов, горячие клавиши, undo/redo, автосохранение.
...
```json
{
  ...
  "steps": [
    { "id": 0, "level": "coarse", "parent_id": null,
      ...
      "keyframe_sec": 3.5, "confidence": 0.82, "source": "auto" }
  ],
...
показывает, что пришло от модели, а что поправил человек. Блок `provenance` уходит в
экспорт, чтобы результат был воспроизводим.
