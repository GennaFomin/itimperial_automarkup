# How the pipeline got here — the pre-detector history

This is the narrative and the tables that lived in the README while the kernel
change-point segmenter was the default. The boundary numbers below predate the learned
detector (see [results/2026-09-05-boundary-final.md](results/2026-09-05-boundary-final.md));
the naming numbers and the rejected ideas are still current.
...
[experiments/research/papers/](experiments/research/papers/).
