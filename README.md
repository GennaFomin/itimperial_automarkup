...
надёжно, а метки — предлагает как черновик с низкой уверенностью, и редактор подсвечивает
их для проверки. Сокращение ручной работы берётся из первого, а не из второго.
